        ...
        <div className="max-w-5xl mx-auto px-6">
          <section id="contact">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-10">
              <div className="flex flex-col gap-8 justify-center md:justify-start bg-white/70 rounded-xl p-8 border border-gray-100 shadow-md">
                <div>
              ...
              <div className="-mx-6 md:w-[600px] md:rounded-xl flex flex-col bg-white/70 border border-gray-100 shadow-md">
                <div className="overflow-hidden shadow-sm border border-gray-200 relative aspect-square w-full md:rounded-xl">
                  <iframe
