    ...
    <>
      <section id="about" className="p-6 bg-[color:var(--secondary-color-3)]">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center md:gap-6">
          <div className="relative h-[600px] -mx-6 -mt-6 md:-my-6 md:mr-0">
            <Image
          ...
          <div>
            <h1 className="text-4xl md:text-5xl text-[color:var(--primary-color)] text-center my-12">
              Notre Histoire
            </h1>
            ...
            <div className="flex gap-8 my-10 md:justify-center">
