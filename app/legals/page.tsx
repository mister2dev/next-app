  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10 text-gray-800 space-y-6">
      ...
      <section>
        ...
        <p>
          Le site est édité par <strong>Bistrot de la Plage</strong>, situé au
          123 Rue des Dunes, 75000 Paris.
          <br />
      ...
      <section>
        ...
        <p>
          Le restaurant décline toute responsabilité quant aux éventuelles
          interruptions du site, à la présence de bugs ou à l’inexactitude des
      ...
      <section>
        ...
        <p>
          ...
          sont la propriété exclusive du restaurant, sauf mention contraire, et
          ne peuvent être reproduits sans autorisation préalable.
        </p>
      </section>
    </main>
  );
